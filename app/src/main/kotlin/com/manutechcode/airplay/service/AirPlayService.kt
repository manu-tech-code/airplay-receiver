package com.manutechcode.airplay.service
...
import com.manutechcode.airplay.MainActivity
import com.manutechcode.airplay.Prefs
import com.manutechcode.airplay.R
import com.manutechcode.airplay.realDisplaySize
import com.manutechcode.airplay.audio.DacpController
import com.manutechcode.airplay.audio.DacpPlayer
import com.manutechcode.airplay.audio.DmapParser
import com.manutechcode.airplay.audio.TrackInfo
import com.manutechcode.airplay.audio.VolumeBroadcast
import com.manutechcode.airplay.bridge.LogListener
import com.manutechcode.airplay.bridge.NativeBridge
import com.manutechcode.airplay.bridge.RaopCallbackHandler
import com.manutechcode.airplay.discovery.NsdServiceManager
import com.manutechcode.airplay.download.VideoDownloader
import com.manutechcode.airplay.renderer.AirPlayVideoPlayer
import com.manutechcode.airplay.renderer.AudioRenderer
import com.manutechcode.airplay.renderer.VideoRenderer
import com.manutechcode.airplay.viewmodel.DebugInfo
...
class AirPlayService : LifecycleService(), RaopCallbackHandler, LogListener {
    ...
    companion object {
        ...
        const val ACTION_PLAY_PAUSE = "com.manutechcode.airplay.PLAY_PAUSE"
        const val ACTION_NEXT = "com.manutechcode.airplay.NEXT"
        const val ACTION_PREV = "com.manutechcode.airplay.PREV"
        const val ACTION_START_SERVER = "com.manutechcode.airplay.START_SERVER"
